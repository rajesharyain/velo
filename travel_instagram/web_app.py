...
async def api_upload_reel_generate(
    ...
    hook_location_hint: str = Form(default=""),
    hook_plain: str = Form(default="0"),
    ...
    try:
        ...
        res = await asyncio.to_thread(
            ...
            hook_location_hint=hook_location_hint,
            hook_plain=str(hook_plain).strip().lower() in ("1", "true", "yes"),
